...
publish_res_bytes=$(sui client publish \
  ...
  --gas 0xcf263e6be11f1e0c841b50c03ff8b11050b390ab487eafb3db0e9dde2680361a \
...
publish_res=$(sui client execute-signed-tx --tx-bytes $publish_res_bytes --signatures $user1_sig --json)
